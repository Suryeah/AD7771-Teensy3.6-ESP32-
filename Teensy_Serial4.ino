  ...
  while (1) {
    if (EDRDY == HIGH) {
      ...
      if (stat1 & (1 << 7))
      {
        ...
        CH3 = (CH2 & 0x7FFFFF);
        Serial4.print("-");
        Serial4.println((CH3 * 0.000000148), DEC);

      } else
      {
        Serial4.println((CH1 * 0.000000148), DEC);
      }
      CH1, CH2, CH3, oct2, temp = 0;
